...
public class Scope {
    ...
    private Map<String, IPSValue> variables;
    ...
    public Scope(Scope p) {
        parent = p;
        variables = new HashMap<String, IPSValue>();
    }

    public void assign(String var, IPSValue value) {
        if(resolve(var) != null) {
    ...
    public Scope copy() {
        ...
        Scope s = new Scope();
        s.variables = new HashMap<String, IPSValue>(this.variables);
        return s;
    }
    ...
    private void reAssign(String identifier, IPSValue value) {
    ...
    public IPSValue resolve(String var) {
        IPSValue value = variables.get(var);
        if(value != null) {
