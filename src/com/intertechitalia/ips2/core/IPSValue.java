...
public class IPSValue implements Comparable<IPSValue> {

    public static final IPSValue NULL = new IPSValue();
    public static final IPSValue VOID = new IPSValue();
    ...
    public List<IPSValue> asList() {
        return (List<IPSValue>)value;
    }
    ...
    @Override
    public int compareTo(IPSValue that) {
